...
@Component({
  ...
  styles: [`
    ...
    .input-wrapper { background-color: #f3f4f6;
     border-radius: 12px;
     padding: 4px;
    ...
    .save-btn { background: linear-gradient(135deg, #6366f1, #4f46e5); color: white; border: none; padding: 12px 28px; border-radius: 12px; font-weight: 600; font-size: 1rem; cursor: pointer; box-shadow: 0 4px 10px rgba(99, 102, 241, 0.3); transition: all 0.2s; }
...
export class AgentDialog {
  ...
  onSave(): void {
    this.dialogRef.close(this.agentData);
  }
}